    ...
    return (
      <div className={ classes.root }>
        <Typography variant="h2" className={ classes.title }>
          <Link href={"https://drive.google.com/file/d/1GslaeH9YV5mdtzQ8sxQYcyXwGavoPOxm/view"} target="_blank">{t('RewardPools.Title')}</Link>
        </Typography>
        ...
        <div className={ classes.intro }>
          <Card className={ classes.addressContainer } onClick={this.overlayClicked}>
            ...
            <div style={{ background: '#96aa3b', opacity: '1', borderRadius: '10px', width: '10px', height: '10px', marginRight: '3px', marginTop:'3px', marginLeft:'6px' }}></div>
          </Card>
        </div>
