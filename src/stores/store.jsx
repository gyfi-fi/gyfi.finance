...
class Store {
      ...
      rewardPools: [
        {
          ...
          link: 'https://pools.balancer.exchange/#/pool/0xDFb0CE371d4858d2ea247c1d2e07b40daF4e9298',
          ...
          tokens: [
            {
              ...
              abi: config.erc20ABI,
              decimals: 18,
              rewardsAddress: config.balancerRewardsAddress2,
              rewardsABI: config.balancerRewardsABI2,
              rewardsSymbol: 'gYFI',
              decimals: 18,
              balance: 0,
              stakedBalance: 0,
        ...
        },
        {
          ...
          website: 'pools.balancer.exchange',
          link: 'https://pools.balancer.exchange/#/pool/0xB6F8187f0AB2bEfc264FaF37367583AD41cDE07e',
  ...
  _getHalfTime = async (web3, asset, account, callback) => {
    ...
    try {
      ...
      callback(null, moment(halfTime * 1000).fromNow())
    } catch(ex) {
      return callback(ex)
    }
  }
